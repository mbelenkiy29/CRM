...
const buildMerchantAdvancesCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Merchant Advances',
...
export function createMerchantAdvancesCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildMerchantAdvancesCrudOpenApi(options)
}
